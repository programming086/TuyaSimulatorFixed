 ...
 */
typedef NS_ENUM(NSUInteger, TYImageBlendOperation) {
 ...
 */
@interface TYEncryptImageFrame : NSObject <NSCopying>
...
@property (nonatomic) TYImageDisposeMethod dispose;     ///< Frame dispose method.
@property (nonatomic) TYImageBlendOperation blend;      ///< Frame blend operation.
...
/**
 ...
 Example:
    ...
    TYImageDecoder *decoder = [TYImageDecoder decoderWithData:data scale:2.0];
    UIImage image = [decoder frameAtIndex:0 decodeForDisplay:YES].image;
 
    // Decode image during download:
    NSMutableData *data = [NSMutableData new];
    TYImageDecoder *decoder = [[TYImageDecoder alloc] initWithScale:2.0];
 ...
 */
@interface TYEncryptImageDecoder : NSObject

@property (nullable, nonatomic, readonly) NSData *data;    ///< Image data.
@property (nonatomic, readonly) TYEncryptImageType type;          ///< Image data type.
 ...
 */
- (nullable TYEncryptImageFrame *)frameAtIndex:(NSUInteger)index decodeForDisplay:(BOOL)decodeForDisplay;
...
/**
 ...
 @discussion It supports encoding single frame image with the type defined in TYImageType.
 It also supports encoding multi-frame image with GIF, APNG and WebP.
 
 Example:
    
    TYImageEncoder *jpegEncoder = [[TYImageEncoder alloc] initWithType:TYImageTypeJPEG];
    jpegEncoder.quality = 0.9;
    [jpegEncoder addImage:image duration:0];
    NSData jpegData = [jpegEncoder encode];
 
    TYImageEncoder *gifEncoder = [[TYImageEncoder alloc] initWithType:TYImageTypeGIF];
 ...
 */
@interface TYEncryptImageEncoder : NSObject

@property (nonatomic, readonly) TYEncryptImageType type; ///< Image type.
 ...
 */
- (nullable instancetype)initWithType:(TYEncryptImageType)type NS_DESIGNATED_INITIALIZER;
...
/**
 ...
 @return The image data, or nil if an error occurs.
 */
+ (nullable NSData *)encodeImage:(UIImage *)image type:(TYEncryptImageType)type quality:(CGFloat)quality;
...
/**
 ...
 @return The image data, or nil if an error occurs.
 */
+ (nullable NSData *)encodeImageWithDecoder:(TYEncryptImageDecoder *)decoder type:(TYEncryptImageType)type quality:(CGFloat)quality;
...
@interface UIImage (TYImageCoder)
...
/**
 ...
 @see ty_isDecodedForDisplay
 */
- (instancetype)ty_imageByDecoded;
 ...
 */
@property (nonatomic) BOOL ty_isDecodedForDisplay;
 ...
 */
- (nullable NSData *)ty_imageDataRepresentation;
...
CG_EXTERN TYEncryptImageType TYImageDetectType(CFDataRef data);

/// Convert TYEncryptImageType to UTI (such as kUTTypeJPEG).
CG_EXTERN CFStringRef _Nullable TYImageTypeToUTType(TYEncryptImageType type);

/// Convert UTI (such as kUTTypeJPEG) to TYEncryptImageType.
CG_EXTERN TYEncryptImageType TYImageTypeFromUTType(CFStringRef uti);

/// Get image type's file extension (such as @"jpg").
CG_EXTERN NSString *_Nullable TYImageTypeGetExtension(TYEncryptImageType type);



/// Returns the shared DeviceRGB color space.
CG_EXTERN CGColorSpaceRef TYCGColorSpaceGetDeviceRGB();

/// Returns the shared DeviceGray color space.
CG_EXTERN CGColorSpaceRef TYCGColorSpaceGetDeviceGray();

/// Returns whether a color space is DeviceRGB.
CG_EXTERN BOOL TYCGColorSpaceIsDeviceRGB(CGColorSpaceRef space);

/// Returns whether a color space is DeviceGray.
CG_EXTERN BOOL TYCGColorSpaceIsDeviceGray(CGColorSpaceRef space);



/// Convert EXIF orientation value to UIImageOrientation.
CG_EXTERN UIImageOrientation TYUIImageOrientationFromEXIFValue(NSInteger value);

/// Convert UIImageOrientation to EXIF orientation value.
CG_EXTERN NSInteger TYUIImageOrientationToEXIFValue(UIImageOrientation orientation);
 ...
 */
CG_EXTERN CGImageRef _Nullable TYCGImageCreateDecodedCopy(CGImageRef imageRef, BOOL decodeForDisplay);
 ...
 */
CG_EXTERN CGImageRef _Nullable TYCGImageCreateCopyWithOrientation(CGImageRef imageRef,
...
/**
 ...
 @return A new image, or NULL if an error occurs.
 */
CG_EXTERN CGImageRef _Nullable TYCGImageCreateAffineTransformCopy(CGImageRef imageRef,
 ...
 */
CG_EXTERN CFDataRef _Nullable TYCGImageCreateEncodedData(CGImageRef imageRef, TYEncryptImageType type, CGFloat quality);


/**
 Whether WebP is available in TYImage.
 */
CG_EXTERN BOOL TYImageWebPAvailable(void);
 ...
 */
CG_EXTERN NSUInteger TYImageGetWebPFrameCount(CFDataRef webpData);
 ...
 */
CG_EXTERN CGImageRef _Nullable TYCGImageCreateWithWebPData(CFDataRef webpData,
                                                           BOOL decodeForDisplay,
                                                           BOOL useThreads,
                                                           BOOL bypassFiltering,
                                                           BOOL noFancyUpsampling);

typedef NS_ENUM(NSUInteger, TYImagePreset) {
    TYImagePresetDefault = 0,  ///< default preset.
    TYImagePresetPicture,      ///< digital picture, like portrait, inner shot
    TYImagePresetPhoto,        ///< outdoor photograph, with natural lighting
    TYImagePresetDrawing,      ///< hand or line drawing, with high-contrast details
    TYImagePresetIcon,         ///< small-sized colorful images
    TYImagePresetText          ///< text-like
};
...
/**
 ...
 @param preset        Preset for different image type, default is TYImagePresetDefault.
 @return WebP data, or nil if an error occurs.
 */
CG_EXTERN CFDataRef _Nullable TYCGImageCreateEncodedWebPData(CGImageRef imageRef,
                                                             BOOL lossless,
                                                             CGFloat quality,
                                                             int compressLevel,
                                                             TYImagePreset preset);
