...
/**
 TYEncryptKVStorageItem is used by `TYEncryptImageKVStorage` to store key-value pair and meta data.
 Typically, you should not use this class directly.
 */
@interface TYEncryptKVStorageItem : NSObject
...
/**
 TYKVStorage is a key-value storage based on sqlite and file system.
 Typically, you should not use this class directly.
 
 @discussion The designated initializer for TYKVStorage is `initWithPath:`.
 ...
 */
@interface TYEncryptImageKVStorage : NSObject
 ...
 */
- (BOOL)saveItem:(TYEncryptKVStorageItem *)item;
 ...
 */
- (nullable TYEncryptKVStorageItem *)getItemForKey:(NSString *)key;
