...
@interface TYEncryptFrameImage : UIImage <TYEncryptAnimatedImage>
...
/**
 ...
 @return An initialized TYEncryptFrameImage object, or nil when an error occurs.
 */
