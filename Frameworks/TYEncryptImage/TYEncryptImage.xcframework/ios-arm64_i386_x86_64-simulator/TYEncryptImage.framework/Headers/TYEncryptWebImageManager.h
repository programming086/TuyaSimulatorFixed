 ...
 */
- (void)prefetchURLs:(nullable NSArray<NSURL *> *)urls DEPRECATED_MSG_ATTRIBUTE("Please use [[TYEncryptWebImagePrefetcher sharedImagePrefetcher] prefetchURLs:] instead");
