...
/// @param aService The service UUID.
/// @param aCallback The callback.
- (void)customNotifyData:(BOOL)b fromPeriphral:(TYBLEPeripheral *)aPeripheral CharactUUID:(NSString *)aCharacteristic serviceUUID:(NSString *)aService completion:(TYBLEAgentCentralNotifyCallback)aCallback;
