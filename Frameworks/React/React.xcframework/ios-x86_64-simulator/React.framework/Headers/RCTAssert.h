...
RCT_EXTERN void RCTSetTRCTFatalHandler(RCTFatalHandler fatalHandler);
RCT_EXTERN RCTFatalHandler RCTGetTYRCTFatalHandler(void);


RCT_EXTERN void RCTSetTRCTFatalForMiniAppHandler(RCTFatalHandler fatalHandler);
RCT_EXTERN RCTFatalHandler RCTGetTYRCTFatalForMinAppHandler(void);
