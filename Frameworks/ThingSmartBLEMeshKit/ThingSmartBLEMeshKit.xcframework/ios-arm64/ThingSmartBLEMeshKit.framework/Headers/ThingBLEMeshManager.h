...
#ifndef ThingSmart_ThingBLEMeshManager
#define ThingSmart_ThingBLEMeshManager
...
@protocol ThingBLEMeshManagerDelegate <NSObject>
...
- (void)activeDeviceSuccessWithName:(nullable NSString *)name deviceId:(nullable NSString *)deviceId error:(nullable NSError *)error;

/// The callback that is used when a sub-device is activated.
/// @param manager The value of ThingBLEMeshManager.
/// @param device The value of ThingBleMeshDeviceModel.
/// @param devId The device ID.
/// @param error An error occurs while activating the sub-device. The values of `name' and 'deviceid' are empty in the response.
- (void)bleMeshManager:(ThingBLEMeshManager *)manager didActiveSubDevice:(ThingBleMeshDeviceModel *)device devId:(NSString *)devId error:(nullable NSError *)error;
...
- (void)activeWifiDeviceWithName:(nullable NSString *)name address:(NSInteger)address mac:(NSInteger)mac error:(nullable NSError *)error;

/// The callback that is used when a device failed to be activated.
/// @param manager The value of ThingBLEMeshManager.
/// @param device The device.
/// @param error An error occurs while processing the request.
- (void)bleMeshManager:(ThingBLEMeshManager *)manager didFailToActiveDevice:(ThingBleMeshDeviceModel *)device error:(NSError *)error;
...
///
@interface ThingBLEMeshManager : NSObject
...
@property (nonatomic, weak) id<ThingBLEMeshManagerDelegate> delegate;
...
/// `-(void) blemeshmanager: (thingblemeshmanager *) manager didscaneddevice: (thingblemeshdevicemodel *) device;` is returned as the scanning result.
...
@interface ThingBLEMeshManager (Command)
...
@interface ThingBLEMeshManager (Raw)
