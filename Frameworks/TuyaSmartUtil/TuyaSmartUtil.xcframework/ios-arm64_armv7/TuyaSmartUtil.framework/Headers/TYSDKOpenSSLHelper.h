...
//#if __has_include(<TuyaSmartOpenSSL/TYSDKOpenSSLHelper.h>)
//#import <TuyaSmartOpenSSL/TYSDKOpenSSLHelper.h>
//#elif __has_include("TYSDKOpenSSLHelper.h")
...
@interface TYSDKOpenSSLHelper : NSObject
