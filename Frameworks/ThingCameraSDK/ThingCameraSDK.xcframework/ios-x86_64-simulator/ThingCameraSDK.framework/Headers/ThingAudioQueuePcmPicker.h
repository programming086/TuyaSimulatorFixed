...
@protocol ThingAudioQueuePcmPickerDelegate <NSObject>
...
@interface ThingAudioQueuePcmPicker: NSObject{
...
@property (nonatomic, weak) id<ThingAudioQueuePcmPickerDelegate> delegate;
