...
typedef void(^TYBLECentralWriteCallback)(NSError *error);
typedef void(^TYBLECentralCallback)(NSData * __nullable data, NSError * __nullable error);

@interface TuyaSmartBLEManager (CustomChannel)
...
- (void)readWithDeviceId:(NSString *)deviceId
             ...
             charactUUID:(NSString *)characteristicUUID
              completion:(TYBLECentralCallback)callback;
...
- (void)writeWithDeviceId:(NSString *)deviceId
              ...
              serviceUUID:(NSString *)serviceUUID
              charactUUID:(NSString *)characteristicUUID
               completion:(TYBLECentralWriteCallback)callback;
