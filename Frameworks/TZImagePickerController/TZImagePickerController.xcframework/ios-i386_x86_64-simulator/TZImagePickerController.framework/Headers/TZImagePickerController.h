...
@property (nonatomic, strong) UIColor *addPictureTintColor;
@property (nonatomic, strong) UIColor *settingArrowTintColor;
@property (nonatomic, strong) UIImage *addPictureImage;
@property (nonatomic, strong) UIColor *addPictureBackgroundColor;
@property (nonatomic, strong) UIImage *settingArrowImage;
@property (nonatomic, strong) NSString *settingBarText;
@property (nonatomic, strong) UIFont *settingBarTextFont;
@property (nonatomic, strong) UIColor *settingBarTextColor;
@property (nonatomic, strong) UIColor *settingBarBackgroundColor;
@property (nonatomic, assign) CGFloat settingBarCorner;
