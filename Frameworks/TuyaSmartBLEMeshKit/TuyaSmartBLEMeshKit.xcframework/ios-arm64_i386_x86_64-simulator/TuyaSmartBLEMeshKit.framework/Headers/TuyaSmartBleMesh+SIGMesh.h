...
+ (TuyaSmartSIGMeshManager * _Nullable)initSIGMeshManager:(TuyaSmartBleMeshModel *)meshModel ttl:(NSInteger)ttl nodeIds:(NSArray * _Nullable)nodeIds;

/// get SIGMeshManager by meshId
/// @param meshId meshId
+ (TuyaSmartSIGMeshManager * _Nullable)getSIGMeshManager:(NSString *)meshId;
...
+ (NSArray <TuyaSmartSIGMeshManager *>*)getAllSIGMeshManager;
...
- (void)removeMeshSubDeviceWithMeshId:(NSString *)meshId deviceId:(NSString *)deviceId success:(TYSuccessHandler)success failure:(TYFailureError)failure;
