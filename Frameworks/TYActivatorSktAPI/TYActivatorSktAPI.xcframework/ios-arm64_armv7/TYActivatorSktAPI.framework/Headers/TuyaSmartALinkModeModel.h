...
@class TuyaSmartALeadModel;
@interface TuyaSmartALinkModeModel : NSObject
...
@property (nonatomic, strong) NSArray<TuyaSmartALeadModel *> *leadList; ///< 详细引导
