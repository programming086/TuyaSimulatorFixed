...
/**
 [^zh]从 stack 顶部开始在视图栈中查找指定类的实例，优先匹配isMemberOf，再匹配isKindOf，未找到则返回nil[$zh]
 ...
 */
- (__kindof UIViewController * __nullable)ty_viewControllerFromTopWithKindOfClass:(Class)cls;
