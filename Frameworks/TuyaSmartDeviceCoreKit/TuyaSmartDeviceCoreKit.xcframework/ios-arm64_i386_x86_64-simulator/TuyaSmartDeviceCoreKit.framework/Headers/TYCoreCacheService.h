...
- (void)updateDeviceOtaInfoWithList:(NSArray<TuyaSmartDeviceOTAModel *> *)otaList
                         completion:(nullable void (^)(NSArray<TuyaSmartDeviceOTAModel *> *))completion;
...
- (void)updateDeviceOtaMode:(TuyaSmartDeviceOTAModel *)otaModel;

/// update the over-the-air (OTA) information.
/// @param otaModel device OTA information.
/// @param completion The callback block after the completion of the update.
- (void)updateDeviceOtaModel:(TuyaSmartDeviceOTAModel *)otaModel
                  completion:(nullable void (^)(TuyaSmartDeviceOTAModel *))completion;
...
- (void)addThingModel:(TuyaSmartThingModel *)model
           completion:(nullable void (^)(TuyaSmartThingModel *thingModel))completion;

- (nullable TuyaSmartThingModel *)getThingModelWithProductId:(NSString *)productId
