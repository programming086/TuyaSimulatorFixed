...
typedef NS_ENUM(NSUInteger, TuyaSmartThingMessageType) {
    /// Property thing message.
    TuyaSmartThingMessageTypeProperty,
    /// Action thing message.
    TuyaSmartThingMessageTypeAction,
    /// Event thing message.
    TuyaSmartThingMessageTypeEvent,
};
...
/// @param progress The update progress.
- (void)device:(TuyaSmartDevice *)device firmwareUpgradeProgress:(NSInteger)type progress:(double)progress __deprecated_msg("This method is deprecated, Use device:otaUpdateStatusChanged: instead");

/// The delegate of changes in device firmware update status.
/// @param device The device instance.
/// @param upgradeStatusModel The model of the device update status.
- (void)device:(TuyaSmartDevice *)device firmwareUpgradeStatusModel:(TuyaSmartFirmwareUpgradeStatusModel *)upgradeStatusModel __deprecated_msg("This method is deprecated, Use device:otaUpdateStatusChanged: instead");
...
- (void)getFirmwareUpgradeInfo:(nullable void (^)(NSArray <TuyaSmartFirmwareUpgradeModel *> *upgradeModelList))success
                       failure:(nullable TYFailureError)failure __deprecated_msg("This method is deprecated, Use -[TuyaSmartDevice checkFirmwareUpgrade:failure:] instead");
...
/// @param success Called when the task is finished.
/// @param failure Called when the task is interrupted by an error.
- (void)upgradeFirmware:(NSInteger)type success:(nullable TYSuccessHandler)success failure:(nullable TYFailureError)failure __deprecated_msg("This method is deprecated, Use -[TuyaSmartDevice startFirmwareUpgrade:] instead");

/// Cancels the firmware updates. Only the update tasks that have not been published can be canceled.
/// @param type The device type of `TuyaSmartFirmwareUpgradeModel`.
/// @param success  Called when the task is finished.
/// @param failure  Called when the task is interrupted by an error.
- (void)cancelUpgradeFirmware:(NSInteger)type success:(nullable TYSuccessHandler)success failure:(nullable TYFailureError)failure __deprecated_msg("This method is deprecated, Use -[TuyaSmartDevice cancelFirmwareUpgrade:failure:] instead");
