...
#import "TuyaSmartThingModel.h"
#import "TuyaSmartUIComponent.h"
...
@property (nonatomic, strong) NSArray<TuyaSmartUIComponent *> *uiComponentList;
...
/// The device access type: 0-Tuya, 1-Matter, 2-TuyaLink
