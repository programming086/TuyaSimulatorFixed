...
/**
 TuyaSmartMQTTConfiguration Universal & Legacy necessarily info
 - Universal Mode:
     appTag: "industry"...
 ...
 */
@interface TuyaSmartMQTTConfiguration : NSObject
...
@protocol TuyaSmartMQTTConfigTransferProtocol <NSObject>
@optional
/// called when need mqtt configuration.
- (nullable TuyaSmartMQTTConfiguration *)transferMQTTConfiguration;
@end

@class TuyaSmartMQTTConfigModel;
@interface TuyaSmartMQTTConfig : NSObject

TYSDK_SINGLETON

/// setup mqtt connect configuration transfer
/// @param transfer mqtt confuguration transfer
- (void)setMqttConfigTransfer:(id<TuyaSmartMQTTConfigTransferProtocol>)transfer;
