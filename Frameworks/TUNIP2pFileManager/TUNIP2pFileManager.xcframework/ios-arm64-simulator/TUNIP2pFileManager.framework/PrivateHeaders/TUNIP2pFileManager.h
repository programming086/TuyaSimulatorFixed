...
@platform: all
*/
@interface TUNIP2pFileManager : TUNIAPIBasePlugin
...
*/
- (void)sendEvent_onSessionStatusChangeWithModel:(TUNIP2pFileManagerThingP2PSessionStatus *)body;
...
*/
- (void)sendEvent_onUploadProgressUpdateWithModel:(TUNIP2pFileManagerProgressEvent *)body;
...
*/
- (void)sendEvent_onDownloadProgressUpdateWithModel:(TUNIP2pFileManagerDownloadProgressEvent *)body;
...
*/
- (void)sendEvent_onDownloadTotalProgressUpdateWithModel:(TUNIP2pFileManagerDownloadTotalProgressEvent *)body;
...
*/
- (void)sendEvent_onFileDownloadCompleteWithModel:(TUNIP2pFileManagerFileDownloadCompletionEvent *)body;
...
*/
- (void)sendEvent_onStreamPacketReceiveWithModel:(TUNIP2pFileManagerStreamDownloadPacketReceivedEvent *)body;
