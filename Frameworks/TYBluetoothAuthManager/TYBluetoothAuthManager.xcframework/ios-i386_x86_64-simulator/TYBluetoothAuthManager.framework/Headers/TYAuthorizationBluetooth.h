//
//  TYAuthorizationBluetooth.h
//  TYAuthorizationManager
//
...
@interface TYAuthorizationBluetooth : NSObject <TYBluetoothAuthProtocol>

// App 权限状态是稳定的，使用 state
@property (nonatomic, readonly, assign) TYCBAuthorizationStatus appAuthState;
// 系统权限状态是不稳定的，使用 status
@property (nonatomic, readonly, assign) TYCBAuthorizationState sysPowerStatus;
