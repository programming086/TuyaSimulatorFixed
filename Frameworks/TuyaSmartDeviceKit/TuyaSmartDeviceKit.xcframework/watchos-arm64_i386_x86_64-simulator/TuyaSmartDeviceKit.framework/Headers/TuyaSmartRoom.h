...
- (void)updateRoomName:(NSString *)roomName success:(nullable TYSuccessHandler)success failure:(nullable TYFailureError)failure;
...
/// @param success     Called when the task is finished.
/// @param failure     Called when the task is interrupted by an error.
- (void)addDeviceWithDeviceId:(NSString *)deviceId success:(nullable TYSuccessHandler)success failure:(nullable TYFailureError)failure;
...
/// @param success     Called when the task is finished.
/// @param failure     Called when the task is interrupted by an error.
- (void)removeDeviceWithDeviceId:(NSString *)deviceId success:(nullable TYSuccessHandler)success failure:(nullable TYFailureError)failure;
...
/// @param success     Called when the task is finished.
/// @param failure     Called when the task is interrupted by an error.
- (void)addGroupWithGroupId:(NSString *)groupId success:(nullable TYSuccessHandler)success failure:(nullable TYFailureError)failure;
...
/// @param success     Called when the task is finished.
/// @param failure     Called when the task is interrupted by an error.
- (void)removeGroupWithGroupId:(NSString *)groupId success:(nullable TYSuccessHandler)success failure:(nullable TYFailureError)failure;
